...
<body class="font-sans antialiased dark:bg-black dark:text-white/50">
                            ...
                            <div class="relative flex items-center gap-6 lg:items-end">
                                <div id="docs-card-content" class="flex items-start gap-6 lg:flex-col">
                                    ...
                                    <div class="pt-3 sm:pt-5 lg:pt-0">
                                        <h2 id="typing-text" class="text-xl font-semibold text-black dark:text-white">
                                        </h2>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            gsap.from(".relative.min-h-screen", {
                duration: 1.5,
                opacity: 0,
                y: 30,
                ease: "power2.out",
            ...
            document.querySelectorAll(".transition").forEach((card) => {
            ...
            fetch('/get-text')
                ...
                .then(text => {
                    ...
                    let cursorBlink = gsap.to(textElement, {
                    ...
                    gsap.to(textElement, {
                        ...
                        ease: "none",
                        onUpdate: function() {
                            textElement.innerHTML = text.substring(0, Math.floor(this.progress() *
                                text.length)) + "<span class='cursor'>|</span>";
                        },
                        onComplete: function() {
                            cursorBlink.kill();
